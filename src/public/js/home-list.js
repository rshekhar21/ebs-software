...
},
{
    key: 'neworder',
    name: 'New Order',
    url: `${urlstr}orders/create`,
    icon: 'orders',
    class: '',
    bsicon: '<i class="bi bi-receipt"></i>',
    img: '',
    rc: '',
    hidden: false,
    version: 'basic'
...
},
{
    ...
    icon: 'contact_page',
    class: '',
    bsicon: '<i class="bi bi-plus-slash-minus"></i>',
    img: '',
    rc: 'eLpjxhZi',
    hidden: false,
    version: 'pro'
...
},
{
    ...
    icon: 'shopping_cart',
    class: '',
    bsicon: '<i class="bi bi-bag-check"></i>',
    img: '',
    rc: 'WnkzKJLc',
    hidden: false,
    version: 'pro'
...
},
{
    ...
    icon: 'currency_rupee',
    class: '',
    bsicon: '<i class="bi bi-currency-rupee"></i>',
    img: '',
    rc: '',
    hidden: false,
    version: 'basic'
...
},
{
    ...
    icon: 'filter_list',
    class: '',
    bsicon: '<i class="bi bi-arrow-return-right"></i>',
    img: '',
    rc: '',
    hidden: false,
    version: 'basic'
},
{
    ...
    icon: 'filter_list',
    class: '',
    bsicon: '<i class="bi bi-file-earmark-text"></i>',
    img: '',
    rc: '',
    hidden: false,
    version: 'basic'
},
{
    ...
    icon: 'filter_list',
    class: '',
    bsicon: '<i class="bi bi-arrow-return-left"></i>',
    img: '',
    rc: '',
    hidden: false,
    version: 'pro'
},
{
    ...
    icon: 'notes',
    class: '',
    bsicon: '<i class="bi bi-card-text"></i>',
    img: '',
    rc: '',
    hidden: false,
    version: 'pro'
},
{
    ...
    icon: 'request_quote',
    class: '',
    bsicon: '<i class="bi bi-wallet2"></i>',
    img: '',
    rc: 'QUbxNZWM',
    hidden: false,
    version: 'basic'
...
},
{
    ...
    icon: '',
    class: '',
    bsicon: '<i class="bi bi-person-check"></i>',
    img: '',
    rc: 'CrOdiKbL',
    hidden: false,
    version: 'pro'
},
{
    ...
    icon: '',
    class: '',
    bsicon: '<i class="bi bi-brightness-low"></i>',
    img: '',
    rc: 'ZKGfSuzx',
    hidden: false,
    version: 'basic'
...
// { key: 'switch', name: 'Switch App', url: '/apps', icon: 'toggle_on', class:'', bsicon:'<i class="bi bi-toggle-off"></i>', img: '', rc: '', hidden: false, version: '' },
{
    ...
    icon: 'logout',
    class: '',
    bsicon: '<i class="bi bi-box-arrow-right"></i>',
    img: '',
    rc: '',
    hidden: false,
    version: 'basic'
